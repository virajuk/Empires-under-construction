...
def go_for_a_tree(display_surface):
    ...
    agent.pick_villager()
    font = pygame.font.SysFont(None, 32)
    agent_text = font.render(f"Agent Target Tree: {agent.tree.rect.center} by Villager {agent.villager.rect.center}", True, (255, 255, 255))
    display_surface.blit(agent_text, (240, current_game_state.HEIGHT + 8))
    ...
    display_surface.blit(path_text, (16, current_game_state.HEIGHT + 48))
